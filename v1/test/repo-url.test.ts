...
describe("normalizeRepoUrl", () => {
  ...
  test("bare slug maps to github.com", () => {
    expect(normalizeRepoUrl("octocat/hello-world")).toBe("github.com/octocat/hello-world");
  });

  test("repoUrlsEqual loosely compares forms", () => {
    expect(repoUrlsEqual("git@github.com:Org/Repo.git", "https://github.com/org/repo")).toBe(true);
    expect(repoUrlsEqual("https://github.com/org/repo", "https://github.com/org/x")).toBe(false);
  });
});
