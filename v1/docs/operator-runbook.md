...
- **One-run actuator probes:** use `jarvis1 run --agent`, `jarvis1 plan --agent`, or `jarvis1 intent --agent` instead of editing config `agentOrder` (see [agents.md](./agents.md#per-run---agent-override)).
