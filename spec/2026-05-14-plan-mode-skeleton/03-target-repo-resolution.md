...
- **Use the shared mode-entry resolver path.** `spec/2026-05-14-cli-modes-and-config-v2/`
...
- **No worktree resolution.** Worktree path computation is introduced
  in `spec/2026-05-14-plan-mode-worktree-and-commits/`. This subspec stops at
  "we know which target repo we'd plan against."

## Implementation hints

- Look for the shared mode-entry helper introduced by
  `spec/2026-05-14-cli-modes-and-config-v2/01-shared-mode-entry.md`. The plan command
...
- [ ] Wire repo resolution into `planCommand` after parsing succeeds, using
  the shared mode-entry helper from `spec/2026-05-14-cli-modes-and-config-v2/`.
