...
function crashOnceMidBoundary(inner: StateStore): StateStore {
  ...
  return {
    ...
    markApprovalAwaiting: (args) => inner.markApprovalAwaiting(args),
    decideApproval: (args) => inner.decideApproval(args),
    claimPipelineContinuation: (pipelineId) => inner.claimPipelineContinuation(pipelineId),
    reopenFailedPipeline: (pipelineId) => inner.reopenFailedPipeline(pipelineId),
