...
- [x] [00 - Git-commit each changed write-loop iteration](./00-per-iteration-git-commit.md)
- [x] [01 - Preserve terminal completion boundary and multi-commit attribution](./01-terminal-boundary-and-attribution.md)
