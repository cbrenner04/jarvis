...
- [ ] [00 — Shared PR module with template-default narrative](./00-shared-pr-template-narrative.md)
- [ ] [01 — Defer patch PR body rewrite to completion pipeline](./01-defer-pr-body-to-completion.md)
