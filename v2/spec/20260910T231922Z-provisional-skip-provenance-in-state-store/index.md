...
- [ ] [00-record-skip-provenance.md](./00-record-skip-provenance.md) — stage rows record provisional vs terminal skip provenance at write time
- [ ] [01-reopen-provisional-skips.md](./01-reopen-provisional-skips.md) — branch-scoped reopen of provisional `skipped` rows to `pending`
