...
- [x] [00 - Step contract check carries dynamic failure reason](./00-step-contract-check-failure-reason.md)
- [x] [01 - Plan-draft normalizer message on contract miss](./01-plan-draft-normalizer-contract-miss-reason.md)
- [x] [02 - Plan-draft contract_miss loop diagnostics and docs](./02-plan-draft-contract-miss-loop-diagnostics.md)
