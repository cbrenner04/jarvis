...
- [x] [00-declared-isolation-class-and-runner-schedule.md](./00-declared-isolation-class-and-runner-schedule.md)

Operator verification (not an acceptance criterion, not agent-checkable): confirm the local `bun run test:v2` aggregate fails pre-fix and passes post-fix on an idle machine.
