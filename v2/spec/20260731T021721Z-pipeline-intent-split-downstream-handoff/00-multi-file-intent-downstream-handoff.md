...
- [x] `intent-output.test.ts` — "lands one valid intent and records file handoff specPath", "idempotent re-land early-return applies the same handoff rules", and "inverting the single-file guard fails single-file handoff" stay green (#2359 N=1 preservation).
