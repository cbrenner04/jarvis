...
`coverage:v2` intentionally covers all of `v2/`, including `*.sandbox-unrunnable.test.ts` files excluded from agent-runnable `test:v2`. Sources: `package.json`, `scripts/run-v2-tests.ts`, `v2/docs/v1-behaviors.md`
