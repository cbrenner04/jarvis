...
| | | daemon-linked-run-row-resume-admission | **gate still awaiting** on pipeline `d2029fbd` | — |
...
| | | pipeline-restart-discards-disposable-stage-state (caller lane) | **gate still awaiting** on pipeline `14108361` | — |
