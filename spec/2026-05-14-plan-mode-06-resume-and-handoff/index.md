...
- **Depends on `spec/2026-05-14-plan-mode-interview/` being merged.**
...
- **PR remains draft.** Resume never marks the PR ready. The PR body
  ...
  `spec/2026-05-14-plan-mode-worktree-and-commits/05-draft-pr.md` and
  `spec/2026-05-14-plan-mode-draft-and-review/`: each new resume commit
...
- **No PR re-creation.** Resume reuses the existing draft PR.
  ...
  `spec/2026-05-14-plan-mode-worktree-and-commits/05-draft-pr.md`.)
...
- Run this spec with `jarvis run spec/2026-05-14-plan-mode-resume-and-handoff/index.md`.
...
- Editing the PR title, the deterministic header, or the narrative
  ...
  `spec/2026-05-14-plan-mode-worktree-and-commits/05-draft-pr.md` stand as-is;
