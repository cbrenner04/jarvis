...
export const DEFAULT_WRITE_STEP_RULES =
  ...
  "Do not add `*ForTest`/`*ForTests` type members, function parameters, module variables, or exported functions/variables, nor `invert*` function parameters, in production code.\n" +
