...
- Split prompt-layer work, patch rewrite semantics, and plan adoption into separate subspecs; do not hide cross-mode behavior changes in one wide review unit.
