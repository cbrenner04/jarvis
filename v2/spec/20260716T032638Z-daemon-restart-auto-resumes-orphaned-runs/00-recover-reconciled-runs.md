...
- [ ] An automatic recovery admission failure records an actionable diagnostic in that run's durable log, leaves its durable status `failed`, and does not prevent attempts for the other reconciled runs.
