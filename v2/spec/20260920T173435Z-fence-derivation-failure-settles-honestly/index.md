...
- [x] [01-log-derivation-reason-before-settlement.md](01-log-derivation-reason-before-settlement.md) — the write-loop writes the named reason to the run log before settling
