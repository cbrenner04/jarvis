...
- [ ] [00 - Establish handoff route readiness](./00-establish-handoff-route-readiness.md) — build a compatible, chain-safe route directory before serving the successor.
