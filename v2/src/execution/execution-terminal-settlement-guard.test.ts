...
const PERMITTED_NONTERMINAL_SET_RUN_STATUS: PermittedNonterminalSetRunStatus[] = [
  ...
  { file: "workflow-runner.ts", line: 4140, functionName: "runIntentResumeCommitAndPublish", status: "in-progress" },
  { file: "workflow-runner.ts", line: 4764, functionName: "runMutationRepairAttempt", status: "in-progress" },
  { file: "workflow-runner.ts", line: 5026, functionName: "runReviewMutationCommitAndPublish", status: "in-progress" },
  { file: "workflow-runner.ts", line: 5064, functionName: "replayMutationFinalization", status: "in-progress" },
