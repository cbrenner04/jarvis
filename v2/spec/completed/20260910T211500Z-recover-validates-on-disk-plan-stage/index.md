...
- [ ] [00-land-on-disk-stage-without-agent-roles.md](./00-land-on-disk-stage-without-agent-roles.md) — recover lands the staged tree directly instead of re-entering the review/actuator loop
- [ ] [01-validate-before-mutating-staged-tree.md](./01-validate-before-mutating-staged-tree.md) — structural refusal happens before the harness-blocker strip touches staged `intent.md`
