...
- [ ] [00 - `jarvis triage` command + CLI wiring](./00-triage-command.md)
- [ ] [01 - Drill-down sections (git, spec, PR, session log)](./01-drill-down-sections.md)
- [ ] [02 - Rule-based suggested-next-moves table](./02-suggested-moves.md)
