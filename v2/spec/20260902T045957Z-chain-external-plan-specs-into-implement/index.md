...
- [ ] [00 - Chain external plan implement dispatch](./00-chain-external-plan-implement-dispatch.md)
- [ ] [01 - Document chained external plan implement](./01-document-chained-external-plan-implement.md)
