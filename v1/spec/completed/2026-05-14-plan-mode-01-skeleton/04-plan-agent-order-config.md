...
`spec/2026-05-14-cli-modes-and-config-v2/00-config-v2-modes.md` and
`spec/2026-05-14-cli-modes-and-config-v2/02-config-cli-and-docs.md`, which implement
...
`spec/2026-05-14-cli-modes-and-config-v2/` now owns that distinction through the v2 config
shape:
...
- **No schema work here.** Validation, bootstrap, `jarvis config show`, and
  ...
  `spec/2026-05-14-cli-modes-and-config-v2/`. This subspec only verifies the skeleton
