...
- [x] [00 - Complete the draft-PR path when only human-only criteria remain](./00-complete-on-human-only-remaining.md)
- [x] [01 - Patch rules: treat human-only criteria as operator-verified](./01-patch-rules-human-only-operator-verified.md)
- [x] [02 - Surface unchecked human-only criteria on the PR](./02-pr-human-verify-checklist.md)
