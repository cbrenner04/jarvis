...
import type { TuiDaemonHealthResult } from "./tui/tui-daemon-client.ts";
// @ts-expect-error TuiDaemonStatusResult must not be exported from tui-daemon-client.ts
import type { TuiDaemonStatusResult } from "./tui/tui-daemon-client.ts";
// @ts-expect-error TuiDaemonStartResult must not be exported from tui-daemon-client.ts
import type { TuiDaemonStartResult } from "./tui/tui-daemon-client.ts";
