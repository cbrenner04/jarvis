...
const PIPELINE_SNAPSHOT_ALPHA: PipelineSnapshot = {
  ...
  finishedAtMs: null,
  stages: [{ stageId: "plan", branchKey: "default", status: "running", workflowInvocationId: "inv-1", startedAt: null, endedAt: null }],
};
...
const PIPELINE_SNAPSHOT_BETA: PipelineSnapshot = {
  ...
  stages: [{ stageId: "s1", branchKey: "default", status: "succeeded", workflowInvocationId: "inv-2", startedAt: null, endedAt: null }],
};
...
const PIPELINE_SNAPSHOT_MULTI: PipelineSnapshot = {
  ...
  createdAt: 1_700_000_000_000,
  finishedAtMs: null,
  stages: [{ stageId: "implement", branchKey: "default", status: "running", workflowInvocationId: PIPELINE_MULTI_INVOCATION, startedAt: null, endedAt: null }],
};
...
function overflowPipelineEntryDeps(view: ReturnType<typeof createViewHost>) {
  ...
  const pipelines = Array.from({ length: pipelineCount }, (_, index) => ({
    ...
    stages: [
      { stageId: "plan", branchKey: "default", status: "succeeded" as const, workflowInvocationId: `inv-${index}`, startedAt: null, endedAt: null },
    ],
  }));
