...
| **P2** (in progress) | [[split-workflow-runner-resume-machines]] — extract-review-debate #3351 DONE; extract-resume-machines planned #3358; twin-dedup follows (its bug already fixed by #3327) | 5,141-line file split; twin resume machines merged (`resumable: true` bug); absorbs issue #2181 and the demoted load-isolation trio |
| **P2** (in progress) | [[split-daemon-run-control-handlers]] — tail-stream/peer-socket #3312, cli-attach-wait #3311, modularize 00-01 #3364; 02-07 remain, inject-binding-deps planned #3357 | 1,318-line closure split; WeakMap back-channel and production test seams retired; guard generalized |
