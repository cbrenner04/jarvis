...
- [ ] Persist agent warnings, usage, cost, agent label/model, phase, and result kind for plan invocations.
...
- [ ] Add unit tests for the shared summary aggregator that cover both patch-mode and plan-mode labels.
- [ ] Add plan-mode integration tests with stubbed agents that verify summaries are printed for success and quota fallback, and omitted for pre-agent failures.
