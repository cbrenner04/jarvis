...
function statusFrame(): IpcFrame {
  return {
    kind: "response",
    id: STATUS_REQUEST_ID,
    result: { state: "running", loadedRevision: "abc123", loadedExecutableDigest: TEST_EXECUTABLE_DIGEST },
  };
}
...
// a steering RPC, and a start request.
