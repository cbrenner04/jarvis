...
- **`v2-build-order.md` aligned** — Phase 5 and related forward refs in
  [`v2-build-order.md`](v2-build-order.md) use role→model semantics per this file
  and [`agent-model-config.md`](agent-model-config.md).
