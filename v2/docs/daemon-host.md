...
```json
{ "pipelines": [{ "pipelineId", "name", "state", "createdAt", "finishedAtMs", "stages": [{ "stageId", "branchKey", "status", "workflowInvocationId" }] }] }
```
