...
- **Depends on `spec/2026-05-14-plan-mode-skeleton/` and
  `spec/2026-05-14-cli-modes-and-config-v2/` being merged.** This spec assumes
...
- **`<name>` source for this spec only:** derived deterministically.
  ...
  - Interactive mode: this spec **does not run agents**, so interactive
    ...
    `spec/2026-05-14-plan-mode-interview/`. Document this in the README update.
  - Agent-proposed names replace this deterministic logic in
    `spec/2026-05-14-plan-mode-interview/03-agent-proposed-spec-name.md`.
...
- **Phase commits in this spec (placeholder content):**
  ...
  2. `plan: draft` — commits a placeholder `spec/<name>/index.md` and a
     ...
     comes from spec/2026-05-14-plan-mode-draft-and-review/.`
...
> `spec/2026-05-14-plan-mode-skeleton/` or `spec/2026-05-14-cli-modes-and-config-v2/` has not
...
- Run this spec with `jarvis run spec/2026-05-14-plan-mode-worktree-and-commits/index.md`.
...
- Any agent invocation. Real spec content arrives in
  `spec/2026-05-14-plan-mode-draft-and-review/`.
- Interactive mode behavior. Stays at the skeleton stub until
  `spec/2026-05-14-plan-mode-interview/` lands.
