...
`spec/2026-05-11-permissions/`. The first subspec verifies the opencode permission
...
- Run this spec with `jarvis run spec/2026-05-11-opencode-as-agent/index.md` **once
