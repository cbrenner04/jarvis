...
- A knip/ts-prune-style gate over `v2/src` production modules runs in `bun run check`, with an explicit allowlist for intentional public surface.
...
- `v2/docs/coding-standards.md` — export hygiene gate scope, allowlist, and manual red-check recipe.
