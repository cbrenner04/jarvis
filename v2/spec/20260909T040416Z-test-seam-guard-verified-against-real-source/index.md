...
- [ ] [00 - Structural test-seam detection](./00-structural-test-seam-detection.md)
- [ ] [01 - Retire production test seams](./01-retire-production-test-seams.md)
- [ ] [02 - Align docs and prompt with enforced shapes](./02-align-docs-and-prompt-with-enforced-shapes.md)
