...
const PERMITTED_TERMINAL_WRITES: PermittedTerminalWrite[] = [
  ...
  { file: "workflow-runner.ts", line: 997, functionName: "executeWorkflow", writer: "commitTerminalRunSettlement" },
  { file: "workflow-runner.ts", line: 1050, functionName: "executeWorkflow", writer: "commitTerminalRunSettlement" },
  {
    file: "workflow-runner.ts",
    line: 2467,
  ...
  { file: "workflow-runner.ts", line: 3167, functionName: "finishReviewedLanding", writer: "commitCompletionBoundary" },
  {
    file: "workflow-runner.ts",
    line: 3919,
  ...
  { file: "write-loop.ts", line: 1242, functionName: "executeWriteLoop", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 1319, functionName: "executeWriteLoop", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 1392, functionName: "executeWriteLoop", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 1444, functionName: "executeWriteLoop", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 1517, functionName: "executeWriteLoop", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 1604, functionName: "executeWriteLoop", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 1705, functionName: "executeWriteLoop", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 1785, functionName: "executeWriteLoop", writer: "commitTerminalRunSettlement" },
  { file: "write-loop.ts", line: 2129, functionName: "finishIterationTimeout", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 2249, functionName: "finishExecuteWriteThrow", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 2694, functionName: "runReadyRepairIteration", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 2752, functionName: "runMutationRepairIteration", writer: "commitCompletionBoundary" },
  { file: "write-loop.ts", line: 3576, functionName: "completionCommitFailed", writer: "commitTerminalRunSettlement" },
  { file: "write-loop.ts", line: 3679, functionName: "readyFailed", writer: "commitTerminalRunSettlement" },
  { file: "write-loop.ts", line: 3960, functionName: "iterationCommitFailed", writer: "commitTerminalRunSettlement" },
];

const PERMITTED_NONTERMINAL_SET_RUN_STATUS: PermittedNonterminalSetRunStatus[] = [
  { file: "workflow-runner.ts", line: 276, functionName: "settlePostCommitShrinkForResume", status: "paused" },
  { file: "workflow-runner.ts", line: 1225, functionName: "executeWorkflow", status: "in-progress" },
  { file: "workflow-runner.ts", line: 4079, functionName: "runIntentResumeCommitAndPublish", status: "in-progress" },
  { file: "workflow-runner.ts", line: 4685, functionName: "runMutationRepairAttempt", status: "in-progress" },
  { file: "workflow-runner.ts", line: 4945, functionName: "runReviewMutationCommitAndPublish", status: "in-progress" },
  { file: "workflow-runner.ts", line: 4982, functionName: "replayMutationFinalization", status: "in-progress" },
  { file: "write-loop.ts", line: 966, functionName: "executeWriteLoop", status: "in-progress" },
  { file: "write-loop.ts", line: 1080, functionName: "executeWriteLoop", status: "in-progress" },
  { file: "write-loop.ts", line: 1212, functionName: "executeWriteLoop", status: "paused" },
  { file: "write-loop.ts", line: 1295, functionName: "executeWriteLoop", status: "paused" },
  { file: "write-loop.ts", line: 1374, functionName: "executeWriteLoop", status: "paused" },
  { file: "write-loop.ts", line: 1499, functionName: "executeWriteLoop", status: "paused" },
  { file: "write-loop.ts", line: 1651, functionName: "executeWriteLoop", status: "paused" },
  { file: "write-loop.ts", line: 1843, functionName: "executeWriteLoop", status: "in-progress" },
  { file: "write-loop.ts", line: 1936, functionName: "executeWriteLoop", status: "budget-soft-stopped" },
  { file: "write-loop.ts", line: 3936, functionName: "_commitRepromptProgressBoundary", status: "paused" },
];
