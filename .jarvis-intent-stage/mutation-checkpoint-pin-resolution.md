...
Splitting does not apply: multiline pin-title resolution, pinning-test extension tolerance, and any plan-draft hollow-pin guard all land on the execution-loop mutation-checkpoint verifier seam.
