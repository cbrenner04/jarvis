...
- The ready gate runs `bun run test` (= `bun test --parallel`) and bails on the first non-zero command.
- A flaky-test stabilization pattern exists (#15: DI seams / injected process tables) to generalize.
