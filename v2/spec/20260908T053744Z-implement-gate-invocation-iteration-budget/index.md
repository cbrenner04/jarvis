...
- [x] [00 - Agent gate shell observability](./00-agent-gate-shell-observability.md)
- [x] [01 - Gate-invocation budget and settlement](./01-gate-invocation-budget-and-settlement.md)
