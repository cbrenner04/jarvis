...
- [ ] Critic, actuator, boundary enforcement, and verdict handling for a reviewed intent use the resolved split workspace.
- [ ] A reviewed-intent run leaves unrelated dirty files in the operator checkout unchanged while those operations run in the split workspace.
- [ ] `v2/docs/first-workflow-walkthrough.md`, `v2/docs/workflow-runner.md`, and `v2/docs/v1-behaviors.md` document the reviewed-intent review workspace.
