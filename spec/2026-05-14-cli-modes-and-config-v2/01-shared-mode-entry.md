...
- **Single ordering.** For all modes that require agents: **parse** (or
  ...
  `spec/2026-05-14-plan-mode-skeleton/03-target-repo-resolution.md` and
  `spec/2026-05-14-plan-mode-skeleton/05-log-server-requirement.md`; do not change those
  semantics here.
