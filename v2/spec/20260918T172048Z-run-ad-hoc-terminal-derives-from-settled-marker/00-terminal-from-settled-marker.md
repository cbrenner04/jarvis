...
- [ ] `deriveOperatorIncidents` timed on a copy of the real store before and after the change shows no material regression; both timings are recorded in the run summary.
