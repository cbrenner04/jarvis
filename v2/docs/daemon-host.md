...
Missing or empty `pipelineId` → `invalid_params`. A retiring (superseded) daemon rejects with `daemon_superseded`, matching other mutating pipeline RPC retirement.
