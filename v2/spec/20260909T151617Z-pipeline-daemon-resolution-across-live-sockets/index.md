...
- [ ] [00 — `pipeline_owner` RPC answers durable pipeline ownership](./00-pipeline-owner-rpc.md)
- [ ] [01 — Pipeline daemon resolution walks every live keyed socket](./01-pipeline-daemon-resolution.md)
