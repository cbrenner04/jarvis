...
- [x] [00 - Codex bindings honor a resolved sandbox mode](./00-codex-binding-honors-sandbox-mode.md)
- [x] [01 - V2 write/implement Codex invocations use the configured sandbox mode](./01-v2-codex-sandbox-mode-from-machine-config.md)
