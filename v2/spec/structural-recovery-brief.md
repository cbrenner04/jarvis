...
| **P1** | Cleanup and home: spec `bulk-terminal-run-dismissal-cli` (implement in flight, PR #4112); [[retention-tiers-for-session-logs-and-telemetry]] (sequence after #4086); [[worktree-materialization-fails-on-committed-node-modules-symlink]] (#4003, half landed); [[daemon-status-reports-stopped-on-a-busy-daemon]] | Orphan telemetry lives forever; a `stopped` probe on a busy machine is a destroying guard acting on an inconclusive answer |
...
- **Issues closed:** #3949, #3974, #3372 (2026-09-18); #3040 (2026-09-20, #4085). #3423's remainder landed #4090 and #3417's landed #4076 — both still open, close them.
