...
- [ ] [00 - Branch-key fan-out plan result binding](./00-branch-key-fan-out-plan-result-binding.md)
- [ ] [01 - Document pipeline-execution fan-out plan dispatch binding](./01-document-pipeline-execution-fan-out-plan-dispatch-binding.md)
- [ ] [02 - Document operator-runbook serial-approval workaround retirement](./02-document-operator-runbook-serial-approval-workaround-retirement.md)
- [ ] [03 - Document v1-behaviors fan-out plan dispatch binding](./03-document-v1-behaviors-fan-out-plan-dispatch-binding.md)
