...
specified in `spec/2026-05-14-plan-mode-skeleton/03-target-repo-resolution.md` and
`spec/2026-05-14-plan-mode-skeleton/05-log-server-requirement.md` — this spec **centralizes
...
- [x] [02 — `jarvis config`, docs, cross-references](./02-config-cli-and-docs.md)

## Conventions

- Run with `jarvis run spec/2026-05-14-cli-modes-and-config-v2/index.md`.
