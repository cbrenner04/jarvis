...
**Operational caveats.** Scoped verifier runs are bounded by `MAX_VERIFICATION_MS` and a concurrency cap; several surviving sites multiply publication wall clock.
