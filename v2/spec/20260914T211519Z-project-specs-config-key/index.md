...
- [ ] [00 — resolver, rejection, intent/plan wiring, docs](00-specs-key-resolver-intent-plan.md)
- [ ] [01 — pipeline chained stages, implement admission, default flip](01-specs-key-pipeline-implement.md)
