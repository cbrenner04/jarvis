...
- [ ] [02-outgoing-generation-drain-and-exit.md](./02-outgoing-generation-drain-and-exit.md) — incoming generation observes drain over the handoff channel; idle outgoing generation exits owning nothing public.
