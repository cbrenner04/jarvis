...
- [x] [00 - Pipeline context loader](./00-pipeline-context-loader.md)
- [x] [01 - Pipeline admission context gate](./01-pipeline-admission-context-gate.md)
- [x] [02 - Malformed persisted context fails stage](./02-malformed-persisted-context-failure.md)
