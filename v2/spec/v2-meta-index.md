...
- [ ] TUI — [build brief](tui-overhaul-brief.md). Jarvis command center: pipeline tree with nested runs, fixed-width columns, wall-clock elapsed, command line for start/steer.
