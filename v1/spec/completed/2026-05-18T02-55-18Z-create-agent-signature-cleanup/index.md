...
- [x] [00 - Tighten createAgent factory signature](./00-tighten-factory-signature.md)
- [x] [01 - Drop dead model fallbacks at plan-mode call sites](./01-drop-plan-mode-model-fallbacks.md)
