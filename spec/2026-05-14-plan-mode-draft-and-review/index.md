...
`spec/2026-05-14-plan-mode-worktree-and-commits/` with **real agent-generated**
...
- **No interview phase.** Interactive mode still hits the skeleton stub.
  Interview lands in `spec/2026-05-14-plan-mode-interview/`.
- **No agent-proposed names.** Naming stays deterministic from
  `spec/2026-05-14-plan-mode-worktree-and-commits/02`. Agent-proposed names land
  in `spec/2026-05-14-plan-mode-interview/03`.
- **No `--resume`.** Still parsed, still inert. Resume lands in
  `spec/2026-05-14-plan-mode-resume-and-handoff/`.

## Decisions

- **Depends on `spec/2026-05-14-plan-mode-worktree-and-commits/` being merged.**
...
- **Idempotence on re-run.** If `jarvis plan` is re-run with the same
  ...
  `spec/2026-05-14-plan-mode-worktree-and-commits/01` applies: re-runs against an
...
- Run this spec with `jarvis run spec/2026-05-14-plan-mode-draft-and-review/index.md`.
