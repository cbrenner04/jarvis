...
`iterationTimeoutMs` (30 min default); a timeout fails the gate with the command
and gate label, e.g. `bun run ready exceeded 1800000ms budget (gate:
completion-ready)`.
