...
- [ ] [01 - Delivered-incident query API](./01-delivered-incident-query-api.md)
- [ ] [02 - Document state-store delivered incidents](./02-document-state-store-delivered-incidents.md)
- [ ] [03 - Document daemon-host pull contract](./03-document-daemon-host-pull-contract.md)
