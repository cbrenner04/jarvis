...
- [ ] Major TUI overhaul — [build brief](tui-overhaul-brief.md). Pipeline-first UI, honest rows and timings, daemon inventory, list agent/model columns; monitor-honesty intents may precede the phase.
