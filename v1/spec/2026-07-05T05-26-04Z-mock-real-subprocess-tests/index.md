...
- [ ] [00 - Subprocess boundary module and shared/git.ts](./00-subprocess-boundary.md)
- [ ] [01 - Mock shared/git tests](./01-mock-shared-git-tests.md)
- [ ] [02 - Audit shared/preload test](./02-audit-shared-preload.md)
