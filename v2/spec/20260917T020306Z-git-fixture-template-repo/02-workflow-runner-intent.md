...
- `initGitWorkspace` stays unconverted — it's called directly, with per-scenario prefixes, by many fixtures in the publication and resume test files that are out of this intent's scope.
