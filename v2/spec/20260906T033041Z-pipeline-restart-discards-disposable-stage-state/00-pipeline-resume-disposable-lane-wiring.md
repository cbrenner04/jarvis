...
- [ ] `pipeline-execution.test.ts` — `failed plan resume preserves %s despite both reset overrides` guard `live worktree claim` stays green (reachable on main: parameterized test at ~6590).
