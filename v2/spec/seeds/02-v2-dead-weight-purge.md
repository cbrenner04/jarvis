...
Pure deletion: code with zero production references, one drifted duplicate type file, one placeholder code path. No refactors, no replacements, no new helpers.
...
- **Delete symbols:** `DaemonRunRejectedError` (daemon.ts — never thrown or caught).
