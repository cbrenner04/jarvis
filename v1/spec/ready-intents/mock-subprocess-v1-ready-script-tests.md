---
name: mock-subprocess-v1-ready-script-tests
---

# Mock the subprocess boundary in v1 ready-script tests

## Problem

`v1/test/ready-script.sandbox-unrunnable.test.ts` (618 lines) spawns real
git/gh subprocesses testing the `bun run ready` gate script.
