...
- [x] [01 - Wire `specTimestamp` flag into plan directory naming](./01-spec-timestamp-flag.md)
- [x] [02 - `commit: false` plan flow](./02-no-commit-plan-flow.md)
- [x] [03 - `--resume` guard for no-commit specs](./03-resume-guard.md)
