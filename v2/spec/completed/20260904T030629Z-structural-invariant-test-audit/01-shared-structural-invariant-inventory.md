...
Subspec 00 published the discovery contract and the script-generated candidate manifest. This slice inventories every in-scope structural-invariant anchor under `shared/**`.
