...
- [ ] [00 - Notifications CLI wait and list](./00-notifications-cli-wait-and-list.md)
- [ ] [01 - Document notifications wake primitive](./01-document-operator-notifications-wake-primitive.md)
