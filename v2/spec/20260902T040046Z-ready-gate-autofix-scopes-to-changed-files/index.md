...
- [ ] [00 - Scoped ready-gate repair autofix biome](./00-scoped-ready-gate-repair-autofix.md)
- [ ] [01 - Durable docs for scoped ready-gate autofix](./01-durable-docs-ready-gate-autofix-scoping.md)
