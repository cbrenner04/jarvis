...
- **Spec cross-references:** Update in-repo spec text that still describes
  ...
  (at minimum `spec/2026-05-14-plan-mode-skeleton/index.md` and
  `spec/2026-05-14-plan-mode-skeleton/04-plan-agent-order-config.md` — either replace
...
- [ ] Adjust stale spec files under `spec/2026-05-14-plan-mode-skeleton/` that document
