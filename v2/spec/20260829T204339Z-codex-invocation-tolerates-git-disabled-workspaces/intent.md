...
- Out of scope: generic advance-on-`error`/`model_config` policy, per-project agent orders, v1's local codex adapter, codex transport-throttling (429) classification.
...
- `v1/docs/quota-signals.md` — codex signal table gains trusted-directory refusal row (v2 shared classifier; note v1 parity status).
