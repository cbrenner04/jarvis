...
- [x] Mutation checkpoint: `// @mutate shared/invocation/agents.ts "--include-partial-messages" -> ""` on the pinned-argv test turns it RED; pin via `shared/invocation/agents.test.ts` (unique basename).
