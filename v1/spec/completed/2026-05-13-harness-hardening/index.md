...
- [x] [04 — Blocker handling](./04-blocker-handling.md)
...
- [x] [11 — Decompose runCommand](./11-decompose-run-command.md)

## Conventions

- Run this spec with `jarvis run spec/2026-05-13-harness-hardening/index.md`.
