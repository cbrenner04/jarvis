...
- Inline-draft and draft plan prompts require behavioral acceptance criteria: criteria state observable behavior and stay silent on schema/tables/files/shapes unless the structure is the contract (public API or wire format). Sources: `prompts/plan/inline-draft.md`, `prompts/plan/draft.md`, `v1/docs/spec-guidance.md`
