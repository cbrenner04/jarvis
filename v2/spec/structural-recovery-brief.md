...
| **P2** (after front-door) | [[implement-admits-externally-landed-specs]] → [[all-spec-documents-external-capable]] | `plan.commit: false` projects ride v2 end to end (#3122; operator ask 2026-08-30); sequenced behind [[pipeline-dispatch-shares-cli-front-door]] so external homes are first-class in the shared resolution, and behind [[cleanup-uses-lossless-git-status]] for the archival slice |
