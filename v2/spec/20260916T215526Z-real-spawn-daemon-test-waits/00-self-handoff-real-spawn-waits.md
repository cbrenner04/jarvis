...
- [ ] `bun test v2/src/daemon/daemon-self-handoff-real-spawn.sandbox-unrunnable.test.ts` runs faster than the same command at the merge base, with identical test titles and test count unchanged or higher.
