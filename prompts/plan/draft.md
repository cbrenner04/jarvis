...
- Acceptance criteria that name the test gate name the scoped script(s) the target repo's `AGENTS.md` prescribes for the touched surfaces, never the bare aggregate.
- `index.md` links every numbered subspec file exactly once; delete any file you replaced.
